    ...
    <>
      <div className="container__box---minibox1">
        <div className="container__box---minibox1--solution">
          <p className="container__box---minibox1--solution-history">0</p>
          <p
      ...
      <div className="container__box---minibox2">
        <div className="container__box---minibox2--button ac-green" id="clear">
          AC
        </div>
        <div className="container__box---minibox2--button">@</div>
        <div className="container__box---minibox2--button">%</div>
        <div className="container__box---minibox2--button" id="divide">
          /
        </div>
        <br />
        ...
        <div className="container__box---minibox2--button" id="multiply">
          *
        </div>
        <br />
        ...
        <div className="container__box---minibox2--button" id="substract">
          -
        </div>
        <br />
        ...
        <div className="container__box---minibox2--button" id="add">
          +
        </div>
        <br />
        <div className="container__box---minibox2--button">&</div>
        <div className="container__box---minibox2--button" id="zero">
          0
        </div>
        <div className="container__box---minibox2--button" id="decimal">
          .
        </div>
        <div className="container__box---minibox2--button" id="equals">
          =
        </div>
      </div>
    </>
